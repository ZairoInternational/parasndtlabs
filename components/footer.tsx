        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <span className="text-xl font-bold">Paras Inspection Service</span>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Your trusted partner for comprehensive quality testing and inspection services worldwide.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">123 Quality Street, Test City, TC 12345</span>
              </div>
            </div>
          </div>
        </div>
